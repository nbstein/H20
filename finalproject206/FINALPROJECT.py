...
# deezer
    ...
    def deezer_dictionary():
        dictionary = deezer_database(d)
        deezer_dic = {}
        for item in dictionary:
            if item in dictionary:
                deezer_dic[item] += 1
            else: deezer_dic[item] = 1 
        return deezer_dic
...
#Give xlabel to the plot
        plt.xlabel("Number of Songs on Deezer Top 100 by Artist")
